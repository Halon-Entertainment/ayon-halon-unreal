...
class LayoutLoader(plugin.LayoutLoader):
    ...
    def apply_settings(cls, project_settings):
        ...
        cls.folder_representation_type = ("json")
        cls.use_force_loaded = (False)
        cls.level_sequences_for_layouts = (True)
        cls.loaded_layout_dir = ("{folder[path]}/{product[name]}")
        cls.remove_loaded_assets = (False)
